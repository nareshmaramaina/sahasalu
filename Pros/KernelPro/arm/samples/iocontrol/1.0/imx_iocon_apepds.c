...
/* Device Module Headers */
//#include "/u01/KERNEL/IMX6/linux-3.0.35/arch/arm/plat-mxc/include/mach/iomux-mx6sl.h"
...
/* Structures Variables Declarations */
...
/*Global Extern Variables Declarations*/
...
volatile int buz_counter=2;


/*Extern Functions Names*/
...
void poweroff_battery(void)
{
	...
	call_usermodehelper("/sbin/battery", argv, envp, 1);
}
...
void rgb_function(void)
{
	...
	static char *envp[]={"HOME=/", "TERM=linux", "PATH=/sbin:/usr/sbin:/bin:/usr/bin", NULL};
	call_usermodehelper("/usr/bin/rgb", argv, envp, 1);
}

...
#define MS_CARD_LOAD            IMX_GPIO_NR(2, 30) 
#define MS_TRACK1_CLK           IMX_GPIO_NR(2, 31) 
#define MS_TRACK1_DATA          IMX_GPIO_NR(2, 20) 
#define MS_TRACK2_CLK           IMX_GPIO_NR(3, 0) 
#define MS_TRACK2_DATA          IMX_GPIO_NR(3, 1) 
#define MS_TRACK3_CLK           IMX_GPIO_NR(3, 2) 
#define MS_TRACK3_DATA          IMX_GPIO_NR(3, 3) 
...
static irqreturn_t clk1_interrupt(int irq, void *dev_id)
{
        ...
        if( pc26 < 1024 ) {
        	...
        	if((__raw_readl(0xf40a0008) >> 20)&1)
                	trackone[pc26]=0x0;
           	else
               		trackone[pc26]=0x1;
                pc26++;
...
//	__raw_writel(( __raw_readl(0xfc29c000 + GPIO_IMR) | 0xe40  ),(0xfc29c000 + GPIO_IMR)) ;
	__raw_writel(( __raw_readl(0xf40a0000 + GPIO_IMR) | 0xc0000000  ),(0xf40a0000 + GPIO_IMR)) ;
...
{
        mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT0__GPIO_2_20) ;
        mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT10__GPIO_2_30) ;
        mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT11__GPIO_2_31) ;
        mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT12__GPIO_3_0) ;
        mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT13__GPIO_3_1) ;
        mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT14__GPIO_3_2) ;
        mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT15__GPIO_3_3) ;

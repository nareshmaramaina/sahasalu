...
#define MX6_BRD_SD1_DAT7	IMX_GPIO_NR(5,10)

static int __init gsmreset_init(void)
{
	mxc_iomux_v3_setup_pad(MX6SL_PAD_SD1_DAT7__GPIO_5_10) ;
	gpio_request(MX6_BRD_SD1_DAT7, "gsmusb_pwr");
        gpio_direction_output(MX6_BRD_SD1_DAT7, 0);
	gpio_set_value(MX6_BRD_SD1_DAT7, 1);
...
static void __exit gsmreset_exit(void)
{
	gpio_set_value(MX6_BRD_SD1_DAT7,0);
//	gpio_set_value(MX6_BRD_ECSPI2_SS0, 0);
//	gpio_set_value(MX6_BRD_LCD_DATA19, 0);
//	gpio_set_value(MX6_BRD_SD2_DAT5, 0);
}
module_init(gsmreset_init);
module_exit(gsmreset_exit);

...
#define MX6_BRD_LCD_DAT23	IMX_GPIO_NR(3,11)

static int __init btpwr_init(void)
{
	mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT23__GPIO_3_11) ;
	gpio_request(MX6_BRD_LCD_DAT23, "bt_pwr");
        gpio_direction_output(MX6_BRD_LCD_DAT23, 0);
	gpio_set_value(MX6_BRD_LCD_DAT23, 1);
...
static void __exit btpwr_exit(void)
{
	gpio_set_value(MX6_BRD_LCD_DAT23,0);
//	gpio_set_value(MX6_BRD_ECSPI2_SS0, 0);
//	gpio_set_value(MX6_BRD_LCD_DATA19, 0);
//	gpio_set_value(MX6_BRD_SD2_DAT5, 0);
}
module_init(btpwr_init);
module_exit(btpwr_exit);

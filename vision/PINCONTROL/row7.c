...
#define MX6_BRD_KEY_ROW7	IMX_GPIO_NR(4,7)

static int __init test_init(void)
{
	mxc_iomux_v3_setup_pad(MX6SL_PAD_KEY_ROW7__GPIO_4_7) ;
	gpio_request(MX6_BRD_KEY_ROW7, "ifd_pwr");
        gpio_direction_output(MX6_BRD_KEY_ROW7, 0);
	gpio_set_value(MX6_BRD_KEY_ROW7, 1);
...
{
	gpio_set_value(MX6_BRD_KEY_ROW7,0);

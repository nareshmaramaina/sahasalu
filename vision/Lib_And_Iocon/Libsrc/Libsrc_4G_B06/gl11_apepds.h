...
/** @brief
 *	This API function is used to Poweron or Poweroff Wifi Module
 * @param val
 *	Description: Wifi power on or Power Off.
 *	Tepe: Input
 *	Range: 0- For power off and 1- For power on.
 * @return
 *	 0 on Success,
...
/** @brief
 *	This API function is used to give Poweron antenna of Wifi Module
 * Note:This API should be called after power on of Wifi Module
 *	Description: Wifi antenna power on or Power Off.
 * @param val
 *	Description: Wifi antenna power on or Power Off.
 *	Tepe: Input
 *	Range: 0- For antenna power off and 1- For antenna power on.
 * @return
 *	 0 on Success,
 *	-1 Failure and
 *	-2 Argument Error.
...
/** @brief
 *	This API Function is used to select GSM SIM1 or SIM2.
 * @param sel
 *	Description: Select SIM1 or SIM2.
 *	Type: Input
 *	Range: '1' - SIM1 and '2' - SIM2.
 * @param baudrate
 *	Description: Open gsm modem with given Baudrate.
 *	Type: Input
 *	Range: 9600 or 115200.
 * @return
 *	 0 on Success.

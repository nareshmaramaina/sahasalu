...
void handleClient(int connfd)
{
	...
	/* when close is executed on a socket the call returns immediately 
	   but the system tries to send the data in the send buffer */
	...
	/* wait for 3 seconds before closing socket */
	close(connfd);
